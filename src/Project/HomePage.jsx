  ...
  return (
    <div>
      ...
      <Typography variant="h4" style={{ color: indigo[500] }}>
        <center>Hire your Freelance Designers</center>
      </Typography>
      <Typography variant="h5" style={{ color: blueGrey[500] }}>
        <center>Find the best freelancers for your next Project</center>
      </Typography>
